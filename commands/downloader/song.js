...
module.exports={name:'song',category:'downloader',description:'Find a YouTube video for song.',async execute(ctx){
 const q=argsText(ctx.args); if(!q)return ctx.reply('Usage: /song song/video name');
