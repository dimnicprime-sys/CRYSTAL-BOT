...
module.exports={name:"summarize",category:'ai',description:"Summarize text or a quoted message.",async execute(ctx){const axios = require('axios');
...
if (!prompt) return ctx.reply('Usage: /summarize your prompt');
