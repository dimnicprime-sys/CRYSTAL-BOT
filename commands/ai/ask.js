...
module.exports={name:"ask",category:'ai',description:"Ask the configured AI.",async execute(ctx){const axios = require('axios');
...
if (!prompt) return ctx.reply('Usage: /ask your prompt');
