...
module.exports={name:"chat",category:'ai',description:"Chat with the configured AI.",async execute(ctx){const axios = require('axios');
...
if (!prompt) return ctx.reply('Usage: /chat your prompt');
